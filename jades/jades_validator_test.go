	...
	tests := []test{
		{
			...
			mockResponse: &http.Response{
				...
				Body:       io.NopCloser(bytes.NewBufferString(`{"simpleReport":{"signaturesCount":1,"validSignaturesCount":1}}`)), //nolint:govet
			},
			mockError:      nil,
			expectedResult: true,
			expectedError:  nil,
		},
		{
			...
			mockResponse: &http.Response{
				StatusCode: http.StatusOK,
				Body:       io.NopCloser(bytes.NewBufferString(`{"simpleReport":{"signaturesCount":1,"validSignaturesCount":0}}`)), //nolint:govet
			},
			mockError:      nil,
		...
		},
		{
			...
			mockResponse: &http.Response{
				StatusCode: http.StatusOK,
				Body:       io.NopCloser(bytes.NewBufferString(`{"simpleReport":{"signaturesCount":0,"validSignaturesCount":0}}`)), //nolint:govet
			},
			mockError:      nil,
			expectedResult: false,
			expectedError:  nil,
		},
		{
			...
			mockResponse:   &http.Response{StatusCode: http.StatusInternalServerError, Body: io.NopCloser(bytes.NewBufferString(""))}, //nolint:govet
			mockError:      nil,
			expectedResult: false,
		...
		},
		{
			...
			mockResponse: &http.Response{
				StatusCode: http.StatusOK,
				Body:       io.NopCloser(bytes.NewBufferString(`{"simpleReport":`)), //nolint:govet
			},
			mockError:      nil,
			expectedResult: false,
