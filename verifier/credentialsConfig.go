...
func (cc cacheBasedCredentialsConfig) GetCredentialStatusConfig(serviceIdentifier string, scope string, credentialType string) (credentialStatus config.CredentialStatus, err error) {
